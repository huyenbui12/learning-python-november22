...
class Test(unittest.TestCase):
    ...
    def test_task1(self):
        ...
        for variant, (input_data, output_data) in enumerate(zip(input_data, output_data), start=1):
            with self.subTest(f"variation #{variant}", input_data=input_data, output_data=output_data):
                self.assertAlmostEqual(exchange.exchange_money(input_data[0], input_data[1]), output_data)
    ...
    def test_task2(self):
        ...
        for variant, (input_data, output_data) in enumerate(zip(input_data, output_data), start=1):
            with self.subTest(f"variation #{variant}", input_data=input_data, output_data=output_data):
                self.assertAlmostEqual(exchange.get_change(input_data[0], input_data[1]), output_data)
    ...
    def test_task3(self):
        ...
        for variant, (input_data, output_data) in enumerate(zip(input_data, output_data), start=1):
            with self.subTest(f"variation #{variant}", input_data=input_data, output_data=output_data):
                self.assertEqual(exchange.get_value_of_bills(input_data[0], input_data[1]), output_data)
    ...
    def test_task4(self):
        ...
        for variant, (input_data, output_data) in enumerate(zip(input_data, output_data), start=1):
            with self.subTest(f"variation #{variant}", input_data=input_data, output_data=output_data):
                self.assertEqual(exchange.get_number_of_bills(input_data[0], input_data[1]), output_data)
    ...
    def test_task5(self):
        ...
        for variant, (input_data, output_data) in enumerate(zip(input_data, output_data), start=1):
            with self.subTest(f"variation #{variant}", input_data=input_data, output_data=output_data):
                self.assertAlmostEqual(exchange.get_leftover_of_bills(input_data[0], input_data[1]), output_data)
    ...
    def test_task6(self):
        ...
        output_data = [8568, 35, 0, 5738705738, 519]
        ...
        for variant, (inputs, output_data) in enumerate(zip(inputs, output_data), start=1):
            with self.subTest(f"variation #{variant}", inputs=inputs, output_data=output_data):
                self.assertEqual(exchange.exchangeable_value(inputs[0], inputs[1], inputs[2], inputs[3]), output_data)
